...
| **Group Name** | Cyber Defenders |
|----------------|-----------------|
| **Student** | Rimsha Bashir |
| **Roll No** | 23F-0583 |
...
**Live Demo:** [Not deployed - Backend required]
...
- ⏱️ **Continuous Recording** - Auto-records every 10 seconds
- 💾 **Local Storage** - Videos saved in browser storage
- ☁️ **Cloud Upload** - Automatic upload to Google Drive
- ⚠️ **Security Warning** - Educational message about vulnerabilities
- 📱 **Device Info Display** - Shows browser and system details
- ⬇️ **Download Option** - Save videos locally
